...
public class BestSongListAdapter extends RecyclerView.Adapter<BestSongListAdapter.SongHolder> {
    ...
    public BestSongListAdapter(AppCompatActivity context, List<Song> arraylist, boolean isPlaylistSong, boolean animate) {
    ...
    public SongHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_best_song_list, parent, false);
    ...
    public class SongHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public SongHolder(View itemView) {
            super(itemView);
            musicTitle = itemView.findViewById(R.id.tv_best_song_title);
            musicArtist = itemView.findViewById(R.id.tv_best_song_title_artist);
