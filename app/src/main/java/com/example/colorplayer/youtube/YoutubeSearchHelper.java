...
public class YoutubeSearchHelper {
    ...
    private static final int NUM_OF_VIDEOS_IN_ONE_REQUEST = 5;
    ...
    private static final String URL_BACK_PART = "&type=video&maxResults=" + NUM_OF_VIDEOS_IN_ONE_REQUEST + "&order=viewCount&key=" + API_KEY;
